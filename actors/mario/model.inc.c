...
Vtx mario_000_displaylist_mesh_layer_1_vtx_0[87] = {
...
Gfx mario_000_displaylist_mesh_layer_1_tri_0[] = {
	...
	gsSPVertex(mario_000_displaylist_mesh_layer_1_vtx_0 + 64, 23, 0),
	gsSP2Triangles(0, 1, 2, 0, 1, 0, 3, 0),
...
Gfx mario_000_displaylist_mesh_layer_1_tri_1[] = {
	gsSPVertex(mario_000_displaylist_mesh_layer_1_vtx_1 + 0, 24, 0),
...
Vtx mario_000_displaylist_mesh_layer_1_vtx_4[41] = {
...
Gfx mario_000_displaylist_mesh_layer_1_tri_4[] = {
	...
	gsSPVertex(mario_000_displaylist_mesh_layer_1_vtx_4 + 32, 9, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
...
Gfx mat_revert_mario_body_v3_layer1[] = {
...
Gfx mat_mario_metal_v3_001_layer1[] = {
...
Gfx mat_revert_mario_metal_v3_001_layer1[] = {
...
Gfx mat_revert_mario_cap_v3_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_face_0___eye_open_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_face_0___eye_open_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_mustache_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_mustache_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_hair_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, 0, 0, 0, 0, ENVIRONMENT, PRIMITIVE, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
	gsSPTexture(65535, 65535, 0, 0, 1),
...
Gfx mat_revert_mario_hair_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_sideburns_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_sideburns_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_face_1___eye_half_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_face_1___eye_half_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_face_2___eye_closed_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_face_2___eye_closed_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_face_7___eye_X_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0_ALPHA, PRIMITIVE, 0, 0, 0, ENVIRONMENT, COMBINED, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_face_7___eye_X_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_wing_1_v3_001_layer4[] = {
	gsSPGeometryMode(G_CULL_BACK, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, COMBINED, COMBINED, 0, ENVIRONMENT, 0),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
	gsSPTexture(65535, 65535, 0, 0, 1),
...
Gfx mat_revert_mario_wing_1_v3_001_layer4[] = {
	gsSPGeometryMode(G_FOG, G_CULL_BACK),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_TEX_EDGE, G_RM_AA_ZB_TEX_EDGE2),
...
Gfx mat_mario_metal_v3_001_layer4[] = {
	gsSPGeometryMode(0, G_FOG | G_TEXTURE_GEN),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, COMBINED, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
...
Gfx mat_revert_mario_metal_v3_001_layer4[] = {
	gsSPGeometryMode(G_FOG | G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_TEX_EDGE, G_RM_AA_ZB_TEX_EDGE2),
...
Gfx mat_mario_gloves_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
...
Gfx mat_revert_mario_gloves_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_cap_inside_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
...
Gfx mat_revert_mario_cap_inside_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mat_mario_shoes_v3_001_layer1[] = {
	gsSPGeometryMode(0, G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(PRIMITIVE, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, COMBINED, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetPrimColor(0, 0, 114, 28, 14, 255),
	gsSPEndDisplayList(),
};

Gfx mat_revert_mario_shoes_v3_001_layer1[] = {
	gsSPGeometryMode(G_FOG, 0),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2),
...
Gfx mario_000_offset_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_body_v3_layer1),
	gsSPDisplayList(mario_000_offset_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_body_v3_layer1),
	gsSPEndDisplayList(),
};

Gfx mario_000_offset_mesh_layer_1_mat_override_metal_v3_001_0[] = {
	gsSPDisplayList(mat_mario_metal_v3_001_layer1),
	gsSPDisplayList(mario_000_offset_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_metal_v3_001_layer1),
	gsSPEndDisplayList(),
};
...
Gfx mario_000_offset_001_mesh_layer_1[] = {
	...
	gsSPDisplayList(mat_revert_mario_body_v3_layer1),
	gsSPDisplayList(mat_mario_cap_v3_layer1),
	gsSPDisplayList(mario_000_offset_001_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_cap_v3_layer1),
	gsSPEndDisplayList(),
};
...
Gfx mario_000_displaylist_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_face_0___eye_open_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_face_0___eye_open_v3_001_layer1),
	gsSPDisplayList(mat_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mat_mario_hair_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_2),
	gsSPDisplayList(mat_revert_mario_hair_v3_001_layer1),
	gsSPDisplayList(mat_mario_sideburns_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_3),
	gsSPDisplayList(mat_revert_mario_sideburns_v3_001_layer1),
	gsSPDisplayList(mat_mario_cap_v3_layer1),
...
Gfx mario_000_displaylist_mesh_layer_1_mat_override_face_1___eye_half_v3_001_1[] = {
	gsSPDisplayList(mat_mario_face_1___eye_half_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_face_1___eye_half_v3_001_layer1),
	gsSPDisplayList(mat_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mat_mario_hair_v3_001_layer1),
...
Gfx mario_000_displaylist_mesh_layer_1_mat_override_face_2___eye_closed_v3_001_2[] = {
	gsSPDisplayList(mat_mario_face_2___eye_closed_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_face_2___eye_closed_v3_001_layer1),
	gsSPDisplayList(mat_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mat_mario_hair_v3_001_layer1),
...
Gfx mario_000_displaylist_mesh_layer_1_mat_override_face_7___eye_X_v3_001_3[] = {
	gsSPDisplayList(mat_mario_face_7___eye_X_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_face_7___eye_X_v3_001_layer1),
	gsSPDisplayList(mat_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_mustache_v3_001_layer1),
	gsSPDisplayList(mat_mario_hair_v3_001_layer1),
...
Gfx mario_000_displaylist_001_mesh_layer_4[] = {
	...
	gsSPDisplayList(mat_mario_wing_1_v3_001_layer4),
	gsSPDisplayList(mario_000_displaylist_001_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_mario_wing_1_v3_001_layer4),
	gsSPEndDisplayList(),
};
...
Gfx mario_000_displaylist_003_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_gloves_v3_001_layer1),
	gsSPDisplayList(mario_000_displaylist_003_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_gloves_v3_001_layer1),
	gsSPEndDisplayList(),
};
...
Gfx mario_005_switch_option_left_hand_cap_mesh_layer_1[] = {
	...
	gsSPDisplayList(mat_revert_mario_cap_v3_layer1),
	gsSPDisplayList(mat_mario_cap_inside_layer1),
	gsSPDisplayList(mario_005_switch_option_left_hand_cap_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_mario_cap_inside_layer1),
	gsSPDisplayList(mat_mario_gloves_v3_001_layer1),
...
Gfx mario_000_offset_011_mesh_layer_1[] = {
	gsSPDisplayList(mat_mario_shoes_v3_001_layer1),
	gsSPDisplayList(mario_000_offset_011_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_mario_shoes_v3_001_layer1),
	gsSPEndDisplayList(),
};
